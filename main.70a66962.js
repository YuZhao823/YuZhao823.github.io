				...
				s.prototype.keydown = function(n) {
					if (/(38|40|27|32)/.test(n.which) && !/input|textarea/i.test(n.target.tagName)) {
						...
						if (n.preventDefault(), n.stopPropagation(), !i.is(".disabled, :disabled")) {
							var o = e(i),
							s = o.hasClass("open");
							if (!s && 27 != n.which || s && 27 == n.which) return 27 == n.which && o.find(r).trigger("focus"),
							i.trigger("click");
	...
	juYr: function(t, e, n) {
		...
		function(n, r) {
			...
			function u(t, e, n) {
				...
				}) : Dt.test(e) ? yt.filter(e, t, n) : (e = yt.filter(e, t), yt.grep(t,
				function(t) {
...
rect.bottom <= (window.innerHeight || document.documentElement.clientHeight))
			...
			function w(t, e) {
				for (var n, i, o = [], r = 0, s = t.length; r < s; r++) i = t[r],
				i.style && (n = i.style.display, e ? ("none" === n && (o[r] = Ht.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && zt(i) && (o[r] = x(i))) : "none" !== n && (o[r] = "none", Ht.set(i, "display", n)));
			...
			function k(t, e, n, i, o) {
				for (var r, s, a, l, u, c, p = e.createDocumentFragment(), f = [], d = 0, h = t.length; d < h; d++) if ((r = t[d]) || 0 === r) if ("object" === yt.type(r)) yt.merge(f, r.nodeType ? [r] : r);
				else if (Jt.test(r)) {
				...
				for (p.textContent = "", d = 0; r = f[d++];) if (i && yt.inArray(r, i) > -1) o && o.push(r);
			...
			function P(t, e, n, i) {
				...
				if (f && (o = k(e, t[0].ownerDocument, !1, t, i), r = o.firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
					for (a = yt.map(T(o, "script"), A), l = a.length; p < f; p++) u = o,
					p !== d && (u = yt.clone(u, !0, !0), l && yt.merge(a, T(u, "script"))),
					n.call(t[p], u, p);
					if (l) for (c = a[a.length - 1].ownerDocument, yt.map(a, j), p = 0; p < l; p++) u = a[p],
					Gt.test(u.type || "") && !Ht.access(u, "globalEval") && yt.contains(c, u) && (u.src ? yt._evalUrl && yt._evalUrl(u.src) : s(u.textContent.replace(ae, ""), c))
				}
				return t
			}
			function L(t, e, n) {
				for (var i, o = e ? yt.filter(e, t) : t, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || yt.cleanData(T(i)),
			...
			function q(t, e, n) {
				...
				return n = n || ce(t),
				n && (s = n.getPropertyValue(e) || n[e], "" !== s || yt.contains(t.ownerDocument, t) || (s = yt.style(t, e)), !vt.pixelMarginRight() && ue.test(s) && le.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)),
				void 0 !== s ? s + "": s
			}
			function R(t, e) {
				return {
			...
			function B(t, e, n, i, o) {
				var r, s = 0;
				for (r = n === (i ? "border": "content") ? 4 : "width" === e ? 1 : 0; r < 4; r += 2)"margin" === n && (s += yt.css(t, n + Ut[r], !0, o)),
				i ? ("content" === n && (s -= yt.css(t, "padding" + Ut[r], !0, o)), "margin" !== n && (s -= yt.css(t, "border" + Ut[r] + "Width", !0, o))) : (s += yt.css(t, "padding" + Ut[r], !0, o), "padding" !== n && (s += yt.css(t, "border" + Ut[r] + "Width", !0, o)));
				return s
			}
			function W(t, e, n) {
				var i, o = ce(t),
			...
			function G(t, e, n) {
				...
				c = u.props;
				for (Q(c, u.opts.specialEasing); r < s; r++) if (i = G.prefilters[r].call(u, t, c, u.opts)) return yt.isFunction(i.stop) && (yt._queueHooks(u.elem, u.opts.queue).stop = yt.proxy(i.stop, i)),
				i;
				return yt.map(c, Y, u),
			...
			function ot(t, e, n, i) {
				...
				for (r = c.shift(); r;) if (t.responseFields[r] && (n[t.responseFields[r]] = e), !l && i && t.dataFilter && (e = t.dataFilter(e, t.dataType)), l = r, r = c.shift()) if ("*" === r) r = l;
					...
					if (! (s = u[l + " " + r] || u["* " + r])) for (o in u) if (a = o.split(" "), a[1] === r && (s = u[l + " " + a[0]] || u["* " + a[0]])) { ! 0 === s ? s = u[o] : !0 !== u[o] && (r = a[0], c.unshift(a[1]));
						break
					}
			...
			yt.extend = yt.fn.extend = function() {
				...
				a++), "object" == typeof s || yt.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++) if (null != (t = arguments[a])) for (e in t) n = s[e],
				i = t[e],
				s !== i && (u && i && (yt.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1, r = n && Array.isArray(n) ? n: []) : r = n && yt.isPlainObject(n) ? n: {},
			...
			yt.extend({
				...
				proxy: function(t, e) {
					var n, i, o;
					if ("string" == typeof e && (n = t[e], e = t, t = n), yt.isFunction(t)) return i = lt.call(arguments, 2),
					o = function() {
			...
			var Ct = function(t) {
					...
					if (!i && ((e ? e.ownerDocument || e: F) !== j && A(e), e = e || j, I)) {
						if (11 !== h && (l = gt.exec(t))) if (o = l[1]) {
							if (9 === h) {
								...
								n
							} else if (d && (s = d.getElementById(o)) && R(e, s) && s.id === o) return n.push(s),
							n
						} else {
							if (l[2]) return G.apply(n, e.getElementsByTagName(t)),
							n;
							if ((o = l[3]) && x.getElementsByClassName && e.getElementsByClassName) return G.apply(n, e.getElementsByClassName(o)),
							n
						}
				...
				function f(t, e, n) {
					...
					function(e, n, o) {
						...
						} else for (; e = e[i];) if (1 === e.nodeType || s) if (p = e[H] || (e[H] = {}), c = p[e.uniqueID] || (p[e.uniqueID] = {}), o && o === e.nodeName.toLowerCase()) e = e[i] || e;
						else {
				...
				function m(t, e, n, o, r, s) {
					...
					i(function(i, s, a, l) {
						...
						} else b = g(b === s ? b.splice(m, b.length) : b),
						r ? r(null, s, b, l) : G.apply(s, b)
					})
				}
				function v(t) {
					for (var e, n, i, o = t.length,
					r = w.relative[t[0].type], s = r || w.relative[" "], a = r ? 1 : 0, l = f(function(t) {
						return t === e
					},
					s, !0), u = f(function(t) {
						return J(e, t) > -1
					...
					s, !0), c = [function(t, n, i) {
						...
						return e = null,
						o
					}]; a < o; a++) if (n = w.relative[t[a].type]) c = [f(d(c), n)];
					else {
				...
				A = e.setDocument = function(t) {
					...
					L = [], P = [], (x.qsa = ht.test(j.querySelectorAll)) && (o(function(t) {
						...
						q.call(t, "[s!='']:x"),
						L.push("!=", it)
					}), P = P.length && new RegExp(P.join("|")), L = L.length && new RegExp(L.join("|")), e = ht.test(O.compareDocumentPosition), R = e || ht.test(O.contains) ?
					function(t, e) {
					...
					filter: {
						...
						PSEUDO: function(t, n) {
							...
							return r[H] ? r(n) : r.length > 1 ? (o = [t, t, "", n], w.setFilters.hasOwnProperty(t.toLowerCase()) ? i(function(t, e) {
								for (var i, o = r(t, n), s = o.length; s--;) i = J(t, o[s]),
								t[i] = !(e[i] = o[s])
							}) : function(t) {
								return r(t, 0, o)
							}) : r
				...
				E = e.compile = function(t, e) {
					...
					r = U[t + " "];
					if (!r) {
						for (e || (e = k(t)), n = e.length; n--;) r = v(e[n]),
				...
				S = e.select = function(t, e, n, i) {
					...
					if (n = n || [], 1 === f.length) {
						...
						for (o = pt.needsContext.test(t) ? 0 : r.length; o--&&(s = r[o], !w.relative[a = s.type]);) if ((l = w.find[a]) && (i = l(s.matches[0].replace(vt, yt), mt.test(r[0].type) && u(e.parentNode) || e))) {
							if (r.splice(o, 1), !(t = i.length && p(r))) return G.apply(n, i),
							n;
							break
						}
					}
			...
			yt.Callbacks = function(t) {
				...
				u = {
					...
					remove: function() {
						...
						function(t, e) {
							for (var n; (n = yt.inArray(e, r, n)) > -1;) r.splice(n, 1),
							n <= a && a--
						}),
						this
					},
					...
					fireWith: function(t, n) {
						return o || (n = n || [], n = [t, n.slice ? n.slice() : n], s.push(n), e || l()),
						this
					},
					fire: function() {
								...
								return function() {
									...
									c = o ? u: function() {
										try {
											...
											t + 1 >= s && (i !== d && (a = void 0, l = [n]), e.rejectWith(a, l))
										}
									};
			...
			yt.extend({
				isReady: !1,
				readyWait: 1,
				ready: function(t) { (!0 === t ? --yt.readyWait: yt.isReady) || (yt.isReady = !0, !0 !== t && --yt.readyWait > 0 || Lt.resolveWith(st, [yt]))
				}
			}),
			...
			yt.event = {
				...
				add: function(t, e, n, i, o) {
					...
					}), e = (e || "").match(It) || [""], u = e.length; u--;) a = ne.exec(e[u]) || [],
					d = g = a[1],
					h = (a[2] || "").split(".").sort(),
				...
				remove: function(t, e, n, i, o) {
					...
					if (m && (l = m.events)) {
						for (e = (e || "").match(It) || [""], u = e.length; u--;) if (a = ne.exec(e[u]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
							...
							d = (i ? p.delegateType: p.bindType) || d, f = l[d] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = f.length; r--;) c = f[r],
							!o && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (f.splice(r, 1), c.selector && f.delegateCount--, p.remove && p.remove.call(t, c));
			...
			yt.Event = function(t, e) {
				...
				t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? E: S, this.target = t.target && 3 === t.target.nodeType ? t.target.parentNode: t.target, this.currentTarget = t.currentTarget, this.relatedTarget = t.relatedTarget) : this.type = t,
				e && yt.extend(this, e),
			...
			function(t, e) {
				yt.event.special[t] = {
					...
					handle: function(t) {
						...
						o = t.relatedTarget,
						r = t.handleObj;
						return o && (o === i || yt.contains(i, o)) || (t.type = r.origType, n = r.handler.apply(this, arguments), t.type = e),
						n
					}
				}
			}),
			...
			yt.extend({
				...
				clone: function(t, e, n) {
					...
					if (e) if (n) for (r = r || T(t), s = s || T(a), i = 0, o = r.length; i < o; i++) O(r[i], s[i]);
					else O(t, a);
					return s = T(a, "script"),
			...
			function(t, e) {
				yt.fn[t] = function(t) {
					for (var n, i = [], o = yt(t), r = o.length - 1, s = 0; s <= r; s++) n = s === r ? this: this.clone(!0),
					yt(o[s])[e](n),
					ct.apply(i, n.get());
			...
			yt.extend({
				...
				style: function(t, e, n, i) {
					if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
						...
						null != n && n === n && ("number" === r && (n += o && o[3] || (yt.cssNumber[a] ? "": "px")), vt.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (u[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, i)) || (l ? u.setProperty(e, n) : u[e] = n))
					}
				},
			...
			function(t, e) {
				yt.cssHooks[e] = {
					get: function(t, n, i) {
						if (n) return ! pe.test(yt.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? W(t, e, i) : Vt(t, de,
						function() {
							return W(t, e, i)
						})
					},
					set: function(t, n, i) {
						...
						return s && (o = _t.exec(n)) && "px" !== (o[3] || "px") && (t.style[e] = n, n = yt.css(t, e)),
						M(t, n, s)
					}
				}
			}),
			yt.cssHooks.marginLeft = R(vt.reliableMarginLeft,
			function(t, e) {
			...
			function(t, e) {
				yt.cssHooks[t + e] = {
					expand: function(n) {
						for (var i = 0,
						o = {},
						r = "string" == typeof n ? n.split(" ") : [n]; i < 4; i++) o[t + Ut[i] + e] = r[i] || r[i - 2] || r[0];
						return o
					}
				},
			...
			yt.fn.extend({
				...
				animate: function(t, e, n, i) {
					...
					s = function() {
						...
						t), r); (o || Ht.get(this, "finish")) && e.stop(!0)
					};
					return s.finish = s,
				...
				stop: function(t, e, n) {
					...
					this.each(function() {
						...
						for (o = r.length; o--;) r[o].elem !== this || null != t && r[o].queue !== t || (r[o].anim.stop(n), e = !1, r.splice(o, 1)); ! e && n || yt.dequeue(this, t)
					})
				},
				finish: function(t) {
					return ! 1 !== t && (t = t || "fx"),
			...
			function(t, e) {
				...
				Te[e] = function(t, e, i) {
					...
					return i || (r = Te[s], Te[s] = o, o = null != n(t, e, i) ? s: null, Te[s] = r),
					o
				}
			});
			...
			yt.extend({
				prop: function(t, e, n) {
					var i, o, r = t.nodeType;
					if (3 !== r && 8 !== r && 2 !== r) return 1 === r && yt.isXMLDoc(t) || (e = yt.propFix[e] || e, o = yt.propHooks[e]),
				...
				valHooks: {
					...
					select: {
						...
						set: function(t, e) {
							...
							r = yt.makeArray(e), s = o.length; s--;) i = o[s],
				...
				trigger: function(t, e, i, o) {
					...
					o || !p.trigger || !1 !== p.trigger.apply(i, e))) {
						if (!o && !p.noBubble && !yt.isWindow(i)) {
							for (l = p.delegateType || d, Se.test(l + d) || (s = s.parentNode); s; s = s.parentNode) f.push(s),
							a = s;
							a === (i.ownerDocument || st) && f.push(a.defaultView || a.parentWindow || n)
						}
						for (r = 0; (s = f[r++]) && !t.isPropagationStopped();) t.type = r > 1 ? l: p.bindType || d,
						c = (Ht.get(s, "events") || {})[t.type] && Ht.get(s, "handle"),
						c && c.apply(s, e),
						(c = u && s[u]) && c.apply && Rt(s) && (t.result = c.apply(s, e), !1 === t.result && t.preventDefault());
						return t.type = d,
						o || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(f.pop(), e) || !Rt(i) || u && yt.isFunction(i[d]) && !yt.isWindow(i) && (a = i[u], a && (i[u] = null), yt.event.triggered = d, i[d](), yt.event.triggered = void 0, a && (i[u] = a)),
						t.result
					}
				},
			...
			yt.extend({
				...
				ajax: function(t, e) {
					...
					r = h.url.replace(Le, ""),
					h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Pe, "+")) : (d = h.url.slice(r.length), h.data && (r += (Ne.test(r) ? "&": "?") + h.data, delete h.data), !1 === h.cache && (r = r.replace(qe, "$1"), d = (Ne.test(r) ? "&": "?") + "_=" + De+++d), h.url = r + d),
			...
			yt.parseHTML = function(t, e, n) {
				...
				var i, o, r;
				return e || (vt.createHTMLDocument ? (e = st.implementation.createHTMLDocument(""), i = e.createElement("base"), i.href = st.location.href, e.head.appendChild(i)) : e = st),
				o = $t.exec(t),
				r = !n && [],
			...
			yt.each(["top", "left"],
			function(t, e) {
				yt.cssHooks[e] = R(vt.pixelPosition,
				function(t, n) {
					if (n) return n = q(t, e),
			...
			function(t) {
				...
				function n(e) {
					return this.each(function() {
						...
						r = t.extend({},
						i.DEFAULTS, n.data(), "object" == typeof e && e); ! o && r.toggle && /show|hide/.test(e) && (r.toggle = !1),
				...
				n.prototype.slide = function(e, i) {
					...
					if (this.$element.trigger(c), !c.isDefaultPrevented()) {
						...
						function() {
							...
							0)
						}).emulateTransitionEnd(n.TRANSITION_DURATION)) : (o.removeClass("active"), r.addClass("active"), this.sliding = !1, this.$element.trigger(f)),
						s && this.cycle(),
						this
					}
				};
